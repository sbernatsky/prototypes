...
public abstract class SpringActionHandlerRegistry implements ActionHandlerRegistry, ApplicationContextAware, InitializingBean {
    private static final Logger LOG = Logger.getLogger(SpringActionHandlerRegistry.class);
